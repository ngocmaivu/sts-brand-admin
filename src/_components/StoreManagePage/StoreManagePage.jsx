        ...
        return (
            <div>
                ...
                <body style={bodyStyle}>
                    <h2 style={{textAlign: 'center',}}>Manage Store</h2>
...
const connectedStoreManagePage = connect(mapState, actionCreators)(StoreManagePage);
export { connectedStoreManagePage as StoreManagePage };