...
function getAllByPage(pageNumber, pageSize) {
    ...
    return fetch(`https://sts-project.azurewebsites.net/api/brands/${user.brandId}/stores?PageNumber=${pageNumber}&PageSize=${pageSize}`, requestOptions).then(handleResponse);
}
